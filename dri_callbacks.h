...
typedef struct _RTL_CRITICAL_SECTION_DEBUG   /* Size=0x30 */
{
    /* 0x0000 */ uint16_t Type;
    /* 0x0002 */ uint16_t CreatorBackTraceIndex;
    uint32_t Padding;
    /* 0x0008 */ RTL_CRITICAL_SECTION* CriticalSection;
...
typedef struct _RTL_CRITICAL_SECTION   /* Size=0x28 */
{
...
typedef struct _PEB   /* Size=0x7c8 */
{
    ...
    /* 0x0018 */ PEB_LDR_DATA* Ldr;
    /* 0x0020 */ RTL_USER_PROCESS_PARAMETERS* ProcessParameters;
    /* 0x0028 */ void* SubSystemData;
    /* 0x0030 */ void* ProcessHeap;
    /* 0x0038 */ RTL_CRITICAL_SECTION* FastPebLock;
    ...
    /* 0x0110 */ RTL_CRITICAL_SECTION* LoaderLock;
